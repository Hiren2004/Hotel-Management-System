      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
			...
			<li><a href="dashboard.php?option=hotel">Add Hotels</a></li>
			<li><a href="dashboard.php?option=view_hotels">View Hotels</a></li>
...
else
{
  ...
  }elseif ($opt=="view_hotels") {
  	include 'view_hotels.php';
  }elseif ($opt=="update_hotel") {
