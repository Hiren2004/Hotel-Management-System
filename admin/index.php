  ...
  <div class="container">
    <div class="row"><br>
      <div class="col-sm-4"></div>
		<div class="col-sm-4 text-center"style="box-shadow:2px 2px 2px;background-color:#C0C0C0;">
			
			<h1 align="center"><b><font style="font-family: 'Libre Baskerville', serif; color: black">Admin Login ?</font></b></h1>
        ...
        <a href="http://localhost/hotel_management/">Go To Dashboard</a>
        </div>
    </div><br>
  </div>
</div>
