...
<body style="margin-top:50px;">
  ...
  <div class="container-fluid" style="background-color:#4286f4;color:#000;"> <!-- Primary Id-->
    <div class="container">
      <div class="row">
        <center>
          <h1 style="background-color:#ed2553; border-radius:50px;display:inline-block;"><b>
        ...
        <div class="col-sm-6 ">
          <form class="form-horizontal" method="post">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <input type="text" name="mobi" class="form-control" placeholder="Enter Your Mobile Number" min="1111111111" max="9999999999" maxlength="10" minlength="10">
              </div>
            </div>
